...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM2_MspDeInit 0 */
    ...
    PA0-WKUP     ------> TIM2_CH1
    */
    HAL_GPIO_DeInit(soapSensor_GPIO_Port, soapSensor_Pin);
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PA6     ------> TIM3_CH1
    */
    HAL_GPIO_DeInit(fanSensor_GPIO_Port, fanSensor_Pin);
  ...
  /* USER CODE END TIM4_MspDeInit 0 */
    ...
    PB6     ------> TIM4_CH1
    */
    HAL_GPIO_DeInit(waterSensor_GPIO_Port, waterSensor_Pin);
